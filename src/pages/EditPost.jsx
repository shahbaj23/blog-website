...
function EditPost() {
  ...
  const handleSubmit = async (e)=>{
    ...
    try {
      const resposne = await axios.patch(`http://localhost:8000/api/post/${id}`, postData, {withCredentials: true, headers: {Authorization: `Bearer ${token}`}})
  ...
  return (
    <div className="md:w-full">
      <h1 className="text-3xl font-bold text-center mt-8">Edit Post</h1>
